        ...
        <div className="space-y-2">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-2 text-sm text-gray-600">
                    ...
                    <span>Haga clic en el mapa para seleccionar la ubicación del incidente</span>
                </div>
                <Button
                    type="button"
                    variant="outline"
            ...
            <div id="location-picker-map" className="h-64 md:h-80 rounded-lg overflow-hidden border-2 border-gray-300"></div>
        </div>
    );
}
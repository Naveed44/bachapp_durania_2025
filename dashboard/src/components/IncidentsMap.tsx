...
export function IncidentsMap({ reports }: IncidentsMapProps) {
        ...
        return (
            <div className="h-96 rounded-lg bg-gray-100 flex items-center justify-center border-2 border-gray-300">
                <div className="text-center">
                    ...
                    <p className="text-gray-500">No hay incidentes con datos de ubicación aún</p>
    ...
    return (
        <div id="incidents-map" className="h-96 rounded-lg overflow-hidden border-2 border-gray-300 shadow-sm"></div>
    );
}
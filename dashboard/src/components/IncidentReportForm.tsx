...
export function IncidentReportForm({ onSubmit }: IncidentReportFormProps) {
  ...
  return (
      <Card>
        <CardHeader>
          <CardTitle>Reportar Nuevo Bache</CardTitle>
          <CardDescription>
            Complete los detalles a continuación y suba fotos del bache
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                  id="description"
                  placeholder="Proporcione información detallada sobre el bache..."
                  value={description}

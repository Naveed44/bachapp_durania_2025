...
export function Dashboard({ reports }: DashboardProps) {
  ...
  return (
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Mapa de Baches</CardTitle>
            <CardDescription>Distribución geográfica de todos los baches reportados</CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Desglose de baches por nivel de gravedad</CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Reportes diarios de baches por gravedad</CardDescription>
                </CardHeader>
                <CardContent>
                  <ResponsiveContainer width="100%" height={250}>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Baches Recientes</CardTitle>
            <CardDescription>Últimos reportes de baches enviados</CardDescription>
          </CardHeader>
          <CardContent>
            {recentReports.length === 0 ? (
                <div className="text-center py-8">
                  <AlertCircle className="w-12 h-12 text-gray-300 mx-auto mb-4" />
                  <p className="text-gray-500">Aún no se han reportado baches</p>
                  <p className="text-gray-400 text-sm mt-2">
                    Envíe su primer reporte de baches para verlo aquí
                  </p>
                </div>
            ) : (
